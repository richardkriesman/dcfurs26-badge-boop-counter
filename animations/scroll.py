...
font5var = {'A':bytearray([0x1E,0x05,0x05,0x1E,0x00]),
            ...
            '0':bytearray([0x0E,0x11,0x0E,0x00]),
            '1':bytearray([0x11,0x1F,0x10,0x00]),
            '2':bytearray([0x19,0x15,0x17,0x00]),
            '3':bytearray([0x11,0x15,0x1F,0x00]),
            '4':bytearray([0x07,0x04,0x1F,0x00]),
            '5':bytearray([0x17,0x15,0x1D,0x00]),
            '6':bytearray([0x1F,0x15,0x1D,0x00]),
            '7':bytearray([0x01,0x01,0x1F,0x00]),
            '8':bytearray([0x1F,0x15,0x1F,0x00]),
            '9':bytearray([0x07,0x05,0x1F,0x00])}
...
class scroll:
    ...
    def on_boop(self):
        with open('boop-count.txt', 'r') as f:
            self.text = str(int(f.read())) + ' boops  '
